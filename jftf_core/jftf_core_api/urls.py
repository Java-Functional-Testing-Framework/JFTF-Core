...
from .views import TestCaseMetadataModelViewSet, TestCaseModelViewSet, TestCaseAdminModelViewSet, \
    TestReportInformationModelViewSet, TestReportModelViewSet, TestReportAdminModelViewSet, TaskResultViewSet, \
    TaskResultAdminViewSet
...
api_router.register(r'test-report-admin', TestReportAdminModelViewSet, basename='test-report-admin')
